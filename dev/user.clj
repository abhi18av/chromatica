(ns user
  (:require [chromatica.application]
            ...
            [chromatica.config :refer [config]]))

(defn dev-system []
  (assoc (chromatica.application/app-system (config))
    :figwheel-system (fw-sys/figwheel-system (fw-config/fetch-config))
    :css-watcher (fw-sys/css-watcher {:watch-paths ["resources/public/css"]})
    :garden-watcher (new-garden-watcher ['chromatica.styles])))
